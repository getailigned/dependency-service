// Dependency Controller - REST API endpoints

import { Request, Response } from 'express';
import { DependencyService } from '../services/dependencyService';
import { LoggerService } from '../services/loggerService';
import { User, CreateDependencyRequest, UpdateDependencyRequest } from '../types';
...
export class DependencyController {
  ...
  async createDependency(req: Request, res: Response): Promise<void> {
    try {
      ...
      const data: CreateDependencyRequest = req.body;
  ...
  async updateDependency(req: Request, res: Response): Promise<void> {
    try {
      ...
      const data: UpdateDependencyRequest = req.body;
  ...
  async getDependencyGraph(req: Request, res: Response): Promise<void> {
    try {
      ...
      const workItemIds = req.query.work_item_ids 
        ? (req.query.work_item_ids as string).split(',')
        : undefined;
  ...
  async detectCycles(req: Request, res: Response): Promise<void> {
    try {
      const user: User = (req as any).user;
